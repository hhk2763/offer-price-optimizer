...
**Live case study and demo:** https://hhk2763.github.io/offer-price-optimizer/
**Full-screen demo:** https://hhk2763.github.io/offer-price-optimizer/demo.html
...
The client is anonymised. The demo in this repo uses fictional part numbers, suppliers and prices, and it replaces the Apps Script backend with an in-browser stand-in, so it runs as a static page.
